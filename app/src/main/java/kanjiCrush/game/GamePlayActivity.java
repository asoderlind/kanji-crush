...
public class GamePlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the animation going into menu screen
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right);

        // Loads button size and text size from default preferences
    ...
    /** Updated button stated, checks completion and updates bg's */
    private void updateBoard(){
        //Log.d(msg, "updateBoard() called");
        mBoard.updateStates();
        if(mBoard.boardIsComplete()) enableNextLevelButton();
    ...
    private void enableNextLevelButton() {
        ...
        if (mLevel >= 4) nextLevelButton.setText(R.string.reset);
    ...
    private void setDimensions() {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int verticalAdjustmentPx = Utils.dpToPx(30f, getApplicationContext()); // Moves all buttons upward a bit
    ...
    private void swapAnimation(int i, int j){
        ...
        // Setting up delayed run function to be called when animations are about to end
        mGridView.postOnAnimationDelayed(() -> {

            // Set text and correct backgrounds of buttons
            button1.setText(mBoard.getKanjiAt(i));
            button2.setText(mBoard.getKanjiAt(j));
            updateBoard();

            // Cancel animation to avoid flickering at the end of animation
            animation1.cancel();
            animation2.cancel();
        }, 350);
    }
